          ...
          {menuOpen && (
            <div className={`${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} absolute top-full left-0 mt-2 w-56 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50`}>
              <ul className="py-1">
                ...
                <li><a href="https://news.agrofy.com.ar/" target="_blank" rel="noopener noreferrer" className="block px-4 py-2 hover:bg-gray-700 hover:text-white">Noticias del sector</a></li>
